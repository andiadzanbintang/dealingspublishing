...
const defaultSettings = {
  ...
  aboutUsFull:
    'Dealings Publishing was created to support researchers, institutions, and knowledge communities through reliable academic publishing. We are committed to quality, openness, and accessibility as core principles of scientific communication.',
  mission:
...
export default function AboutPage() {
  ...
  return (
    <>
      <Helmet>
        <title>About Us — Dealings Publishing</title>
        <meta
          name="description"
          content={
            settings.aboutUsShort ||
            "Learn about Dealings Publishing's mission, vision, and journey in advancing academic research and publishing."
          }
        />
      </Helmet>
              ...
              <div>
                ...
                >
                  {storyParagraphs.length > 0 ? (
                    ...
                    <>
                      <p>
                        Dealings Publishing was created to support researchers,
