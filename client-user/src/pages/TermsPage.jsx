...
export default function TermsPage() {
  return (
    <>
      <Helmet>
        <title>Terms of Service — Dealings Publishing</title>
        <meta
          name="description"
          content="Read the Dealings Publishing terms of service for using our website and content."
        />
      </Helmet>
        ...
        <div className="container-custom max-w-4xl">
          <div className="mb-10 flex items-start gap-4 p-6 bg-neutral-50 border border-neutral-200 rounded-2xl">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-600 leading-relaxed">
                These terms govern your use of the Dealings Publishing website,
          ...
          <div className="rich-content">
            ...
            <p>
              ...
              Dealings Publishing or other users.
            </p>
            ...
            <p>
              ...
              and other materials are owned by or licensed to Dealings Publishing.
            ...
            <p>
              ...
              resources. These links are provided for convenience only. Dealings
            ...
            <p>
              Users may subscribe to receive updates from Dealings Publishing.
            ...
            <p>
              To the fullest extent permitted by law, Dealings Publishing shall not
